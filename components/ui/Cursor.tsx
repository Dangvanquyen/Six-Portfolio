...
export const Cursor = () => {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-100000 sm:block hidden ">
      <div
        className="absolute rounded-full dark:bg-white bg-black pointer-events-none"
        style={{
          width: "6px",
          height: "6px",
      ...
      <div
        className="absolute rounded-full border dark:border-white/60 border-black/60 pointer-events-none"
        style={{
          width: isHovering ? "38px" : "24px",
          height: isHovering ? "38px" : "24px",
          transform: "translate(-50%, -50%)",
